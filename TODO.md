...
3. （可选）文章部分，“系列、难度”部分，屏幕向下滑动后，在左侧“弹”一下展示出“文章标题、OI-wiki快捷链接、标签tags”。

4. （可选）音乐播放器的音量调节器，打开一个小容器，有吊图，根据音量的高低来判断展示什么图片/gif，像拖拉机的摇杆一样按住拖动，
...
6. （可选）增加备份功能——用脚本将数据库中的内容备份到本都，并且定期上传到github。
