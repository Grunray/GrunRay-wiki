---
title: OpenClaw 下的本地文件检索：RAG 只做擅长的那部分
...
tags:
  ...
  - Docker
  - 文件检索
summary: "面向内网大量 PDF / Word / Excel / DWG 说明文件的本地检索：OpenClaw skill 编排 + LightRAG，文件名定位与数值对比不硬塞进 RAG。"
locale: zh
series: 项目与工程
pinned: false
pinned_order: 40
published_at: '2026-06-09T23:40:00'
updated_at: '2026-06-09T23:40:00'
...
仓库：（私有，暂不列出）。公开时间线很短：**2026-06-09** 当天建仓并完成主要提交。它**不是**某个业务产品的正式交付件；只是在接 OpenClaw agent 时，把「文件库问答」拆成可部署的服务 + skill。文中只谈技术结构，不挂任何甲方品牌。
