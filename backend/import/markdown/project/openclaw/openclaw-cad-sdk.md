---
title: 给 OpenClaw 用的 CAD 图纸桥：开图、模糊找字、缩放到图元
...
tags:
  ...
  - C#
  - HTTP
summary: "把 AutoCAD / 中望 CAD 里的开图、按文字模糊定位图元、视图缩放，封装成 localhost HTTP，再交给 OpenClaw skill 调用。"
locale: zh
series: 项目与工程
pinned: false
pinned_order: 10
published_at: '2026-05-30T23:49:00'
updated_at: '2026-05-30T23:49:00'
